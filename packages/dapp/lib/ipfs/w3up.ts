import { CAR, Delegation, DID } from '@ucanto/core';
...
if (
  ...
  !process.env.WEB3_STORAGE_SPACE
) {
  throw new Error(
    'WEB3_STORAGE_KEY, WEB3_STORAGE_PROOF, WEB3_STORAGE_SPACE and WEB3_STORAGE_DID must be set',
  );
}
